...
public class ProductPricingTest {
	...
	private Product fanta = Product.ProductBuilder.create().withName("fanta").withPrice(priceOfOneFanta).withSaleType(ProductSaleType.UNIT).build();
	...
	//fanta orders
	private OrderProduct orderOneFanta = OrderProductBuilder.create().withProduct(fanta).withSpecialPricingRule(nPlusM).withUnits(1).build();
	private OrderProduct orderFourFanta = OrderProductBuilder.create().withProduct(fanta).withSpecialPricingRule(nPlusM).withUnits(4).build();
	...
	public void must_return_30_when_pricing_one_fanta_available_in_special_sale() {
        ...
        assertThat(orderOneFanta.getTotalPriceDetails()).isEqualTo("fanta : 1 X 0.3	 = 0.3$  (Promotion) Free units: 0");
	}
	...
	public void must_return_30_when_pricing_four_fanta_available_in_special_sale() {
        ...
        assertThat(orderFourFanta.getTotalPriceDetails()).isEqualTo("fanta : 4 X 0.3	 = 0.9$  (Promotion) Free units: 1");
	}
